...
function SummarizeEmail({ email }) {
    ...
    <div >
        <button
        className="p-2 bg-green-300 hover:bg-green-400 rounded fixed bottom-0 left-64 m-2 w-50 px-2"
        ...
        {summarizedText &&
          (
          <div className='border-solid border-2 border-zinc-600 p-2 mt-2 mr-2'>
